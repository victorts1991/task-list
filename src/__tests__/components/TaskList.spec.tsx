...
describe('App Page', () => {
  it('should be able to add a task', async () => {
    ...
    const addedThirdTaskTitle = screen.getByText('Fazer café')

    expect(addedThirdTaskTitle).toBeInTheDocument()
    expect(addedThirdTaskTitle).toHaveTextContent('Fazer café')
    expect(addedThirdTaskTitle.parentElement).not.toHaveClass('completed')
  })
